...
[Lodestone](https://lode.gg/plugin/sign) · [Documentation](https://docs.lode.gg/sign/server-owners/overview) · [API](https://github.com/Lodestones/Sign-API)
...
| **Voice chat** | `{voice}` placeholder with Simple Voice Chat + [Amplifier](https://lode.gg/plugin/amplifier) integration                                       | Not available |
